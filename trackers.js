/* Nelson Moore – trackers.js (always-on)
 * Centralized third-party loader for the consent demo.
 * Airgap gates these until consent; do not wrap in client-side consent checks.
...
(function(){
  ...
  window.NelsonMooreTracks = { loadAll, load: Vendors };
  window.GymfinityTracks = window.NelsonMooreTracks; /* alias for gymdemo compatibility */
